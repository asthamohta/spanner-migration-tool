...
func TestProcessDataRow(t *testing.T) {
	...
	ProcessDataRow(conv, tableId, colIds, conv.SrcSchema[tableId], conv.SpSchema.Tables[tableId], []string{"4.2", "6", "prisoner zero"}, internal.AdditionalDataAttributes{})
...
func TestConvertData(t *testing.T) {
	...
	for _, tc := range singleColTests {
		...
		t.Run(tc.in, func(t *testing.T) {
			at, ac, av, err := ConvertData(conv, tableId, []string{colId}, conv.SrcSchema["t1"], conv.SpSchema.Tables["t1"], []string{tc.in}, internal.AdditionalDataAttributes{})
...
func TestConvertTimestampData(t *testing.T) {
	...
	for _, tc := range timestampTests {
		...
		t.Run(tc.in, func(t *testing.T) {
			atable, ac, av, err := ConvertData(conv, tableId, []string{colId}, conv.SrcSchema[tableId], conv.SpSchema.Tables[tableId], []string{tc.in}, internal.AdditionalDataAttributes{})
...
func TestConvertMultiColData(t *testing.T) {
	...
	for _, tc := range multiColTests {
		t.Run(tc.name, func(t *testing.T) {
			...
			atable, acols, avals, err := ConvertData(conv, srcTable.Id, tc.colIds, conv.SrcSchema[tableId], conv.SpSchema.Tables[tableId], tc.vals, internal.AdditionalDataAttributes{})
...
func TestConvertError(t *testing.T) {
	...
	for _, tc := range errorTests {
		t.Run(tc.name, func(t *testing.T) {
			conv := buildConv(spTable, srcTable)
			_, _, _, err := ConvertData(conv, srcTable.Id, colIds, conv.SrcSchema[tableName], conv.SpSchema.Tables[tableName], tc.vals, internal.AdditionalDataAttributes{})
